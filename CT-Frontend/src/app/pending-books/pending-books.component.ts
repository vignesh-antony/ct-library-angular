...
@Component({
    ...
    styleUrls: ['../borrowed-books/borrowed-books.component.scss','./pending-books.component.scss']
})
export class PendingBooksComponent implements OnInit {
    ...
    constructor(private activatedRoute:ActivatedRoute, private dateService:DateService) { 
    ...
    getTimeInterval(date:string){
        ...
        return "Late by " + days + "d " + hour + "h " + mins + "m " + secs + "s";
    }
    ngOnInit(): void {
        this.prevDate = [];
